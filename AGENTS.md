...
- **Stego detection robustness**: Kakushi peek/reveal now use a configurable alpha threshold and multi-region scan fallback to better tolerate browser decode differences.
