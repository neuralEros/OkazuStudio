        ...
        const state = {
            ...
            opacity: 0.8, brushPercent: DEFAULT_ERASE_BRUSH, feather: DEFAULT_FEATHER, featherPx: DEFAULT_FEATHER_PX, isFeatherFixed: false, isErasing: true, isDrawing: false,
        ...
        function init() {
            ...
            els.featherModeBtn.addEventListener('click', () => {
                setFeatherMode(!state.isFeatherFixed);
            });
            ...
            setFeatherMode(state.isFeatherFixed);
            setFeather(state.isFeatherFixed ? state.featherPx : state.feather);
