        ...
        const DEFAULT_FEATHER_PERCENT = 1;
        ...
        const state = {
            ...
            opacity: 0.8,
            brushPercent: DEFAULT_ERASE_BRUSH,
            featherMode: 'percent',
            featherPercent: DEFAULT_FEATHER_PERCENT,
            featherPx: DEFAULT_FEATHER_PX,
            isErasing: true,
            isDrawing: false,
            ...
            brushSettings: {
                erase: { brushPercent: DEFAULT_ERASE_BRUSH, featherPercent: DEFAULT_FEATHER_PERCENT, featherPx: DEFAULT_FEATHER_PX },
                repair: { brushPercent: DEFAULT_REPAIR_BRUSH, featherPercent: DEFAULT_FEATHER_PERCENT, featherPx: DEFAULT_FEATHER_PX }
            },
        ...
        const els = {
            ...
            featherModeBtn: document.getElementById('featherModeBtn'), featherModeIcon: document.getElementById('featherModeIcon'),
        ...
        function init() {
            ...
            els.featherModeBtn.addEventListener('click', () => {
                const nextMode = state.featherMode === 'pixel' ? 'percent' : 'pixel';
                setFeatherMode(nextMode);
            });
