            ...
            return new Promise((resolve) => {
                ...
                const createBtn = (text, onClick, isCancel = false) => {
                    ...
                    if (isCancel) {
                         ...
                         btn.className = "w-full py-2.5 px-4 bg-transparent border-accent text-accent hover:bg-[var(--accent-strong)] hover:text-[var(--accent-ink)] hover:border-accent-strong rounded-sm transition-all text-base font-bold shadow-sm";
                    } else {
                         // Using accent-action style (Export button style) with text-base
                         btn.className = "w-full py-2.5 px-4 accent-action rounded-sm transition-all text-base font-bold shadow-sm";
                    }
